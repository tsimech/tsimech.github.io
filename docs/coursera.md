---
title: "Coursera | Staff Product Manager, Search"
...
Staff Product Manager with 13+ years building ML/AI-driven search and discovery experiences at enterprise scale. Recently delivered conversational AI product (AvantorAI) that provided intuitive navigation and contextual assistance with measurable engagement and revenue impact. Expert in search relevance optimization, rapid experimentation, and cross-functional leadership across global platforms serving millions of users.

**Core Expertise:** AI-Driven Search & Discovery | Conversational Search | Search Personalization | ML/IR Integration | Product Strategy | A/B Testing | Revenue Growth | Cross-Functional Leadership

---

### KEY ACHIEVEMENTS

- **Conversational Search Innovation:** Conceived and launched AvantorAI, a conversational AI agent (first in scientific eCommerce) guiding customer navigation, product discovery, and contextual assistance throughout their journey; recognized by CEO in Q2 earnings call
...
- **Search Relevance Leadership:** Drove CTR +7.5%, Top-5 click activity +15%, search usage +13% (2023) through ML-driven relevance optimization, semantic understanding, and personalized ranking at scale
- **0-to-1 Product Launches:** Delivered multiple products from ideation to launch with proven results: conversational AI, chemical structure search modernization (20K landing pages, SEO growth), visual category browse experience
...
- **Conceived and launched AvantorAI**, conversational AI agent enabling customer interaction for discovery, navigation, and product inquiries—delivering seamless AI experience throughout user journey; recognized in company-wide Town Hall and CEO Q2 earnings call
- Improved search relevance and quality by leveraging ML advances, enhancing query understanding and personalized ranking for high-intent search experience
- Drove rapid experimentation through A/B testing, analyzing results and presenting data-driven insights to executive leadership for strategic decisions
...
- Defined multi-year product strategy and quarterly priorities for search, personalization, and discovery experiences using WSJF (Weighted Shortest Job First) and Business Value prioritization frameworks
- Led platform-level capabilities supporting multiple use cases: global eCommerce search, product discovery, personalized search ranking, and merchandising optimization across diverse business units
...
**Delivered measurable business outcomes through ML/AI-driven relevance and rapid experimentation:**
- 2023 results: CTR +7.5%, Top-5 click activity +15%, search usage +13%, customer complaints reduced to <10/month despite millions of queries processed
- Partnered with A/B testing and data science teams to validate hypotheses, optimize user experience, and drive data-driven iteration
- Conducted CX/UX audits using proprietary search quality framework, establishing and rolling out standards
...
- Improved search relevance for global, multilingual audience through IR/ML optimization, query understanding, and personalized ranking
...
**Search & AI/ML:** Enterprise Search Platforms (Lucidworks Fusion, Endeca, FAST) | Conversational AI & LLMs | Semantic Search | Query Understanding | Search Personalization & Ranking | IR & ML Integration  
**Experimentation & Analytics:** A/B Testing & Multivariate Testing | Statistical Analysis | Google Analytics & Adobe Analytics | Tableau | KPI Definition | Conversion Rate Optimization  
**Product & Strategy:** Product Roadmapping | WSJF Prioritization | Agile/SAFe | OKRs & KPIs | 0-to-1 Product Development | Business Case Development | ROI Modeling  
**Platform & Technical:** eCommerce Platforms | Marketplace Products | Platform Migration | API Integration | Data Science Collaboration | SQL | Jira/Confluence  
**Leadership:** Cross-Functional Team Leadership (30+ members) | Executive Stakeholder Alignment | Vendor Management | Global Product Management | Mentorship
