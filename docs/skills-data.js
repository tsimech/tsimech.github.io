...
const skillsData = {
  ...
  children: [
    ...
    // ── 2. Search Platforms ───────────────────────────────────────────────
    {
      ...
      children: [
        { name: "Lucidworks Fusion", value: 60,
    ...
    // ── 3. Search UX & Quality ────────────────────────────────────────────
    {
      ...
      children: [
        ...
        { name: "Autocomplete", value: 100,
          ...
          roles: "TF 2010–2024 · Avantor 2024–2026" },
        { name: "Multilingual Search", value: 90,
    ...
    // ── 5. Product & Leadership ───────────────────────────────────────────
    {
      ...
      children: [
        ...
        { name: "SAFe", value: 90,
          ...
          roles: "TF 2010–2024" },
        { name: "WSJF / Prioritization", value: 95,
    ...
    // ── 6. Technical Skills ───────────────────────────────────────────────
    {
      ...
      children: [
        ...
        { name: "GitHub Copilot", value: 90,
          ...
          roles: "Current" },
        { name: "GitHub / Git / VS Code", value: 90,
          ...
          roles: "Current" },
        { name: "JavaScript / HTML / CSS", value: 35,
          desc: "Custom D3.js visualizations (this page), dashboard integration, responsive layouts, event handling — proficient and actively used",
    ...
    // ── 7. Domain Expertise ───────────────────────────────────────────────
    {
      ...
      children: [
        ...
        { name: "Scientific Taxonomy", value: 70,
          ...
          roles: "TF 2010–2024" },
        { name: "SEO / Organic Discovery", value: 55,
...
const skillsRecencyScores = {
  ...
  "Search UX Testing": 90, "Personalization": 65,
  ...
  // Technical Skills
  "VBA": 80, "GitHub Copilot": 100, "GitHub / Git / VS Code": 100,
  "JavaScript / HTML / CSS": 80, "Python": 100, "SQL": 65, "Database Design": 65,
  // Domain Expertise
